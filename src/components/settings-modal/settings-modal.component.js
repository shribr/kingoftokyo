...
export function createSettingsModal() {
  ...
  <div class="settings-tabs" style="display:flex; border-bottom:2px solid #333; margin-bottom:0; background:#1c1c1c; border-radius:0.6vh 0.6vh 0 0; position:sticky; top:0; z-index:50; box-shadow:0 0.2vh 0.6vh -0.2vh rgba(0,0,0,.7); padding-bottom:2px;" role="tablist">
      <button type="button" class="tab-button active" data-tab="gameplay">
        <span style="margin-right: 0.8vw;">🎮</span>Gameplay
      </button>
      <button type="button" class="tab-button" data-tab="interface">
        <span style="margin-right: 0.8vw;">🎨</span>Interface
      </button>
      <button type="button" class="tab-button" data-tab="themes">
      ...
      <button type="button" class="tab-button" data-tab="scenarios">
        <span style="margin-right: 0.8vw;">🧪</span>Scenarios
      </button>
      <button type="button" class="tab-button" data-tab="archives">
        <span style="margin-right: 0.8vw;">🗂</span>Archives
      </button>
      <button type="button" class="tab-button" data-tab="replay">
        <span style="margin-right: 0.8vw;">▶️</span>Replay
      </button>
      <button type="button" class="tab-button" data-tab="ai">
        <span style="margin-right: 0.8vw;">📊</span>Analytics & Insights
      </button>
      <button type="button" class="tab-button" data-tab="devtools">
    ...
    <form class="unified-modal-form">
      ...
      <div class="tab-content" data-tab-content="themes" style="display: none;">
        <div class="section">
          ...
          <p style="font-size:13px;opacity:.85;line-height:1.5;margin-bottom:16px;">
            Choose a color theme and see a live preview of how game elements will look.
          </p>
          
          <div class="field">
            <label class="field-label">Select Theme</label>
            <div class="theme-selector-grid">
              <!-- Dark Theme (Default) -->
              <div class="theme-preview-card active" data-theme="dark">
                <div class="theme-preview-header">
                  <div class="theme-preview-check">✓</div>
                  <h4>Dark Theme</h4>
                  <span class="theme-badge">Default</span>
                </div>
                <div class="theme-preview-sample">
                  <div class="sample-modal">
                    <div class="sample-modal-header">Game Modal</div>
                    <div class="sample-modal-body">
                      <div class="sample-stat-card dark">
                        <span class="sample-icon">❤️</span>
                        <span class="sample-value">10</span>
                      </div>
                      <div class="sample-button dark">Roll Dice</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="theme-preview-card" data-theme="light">
                <div class="theme-preview-header">
                  <div class="theme-preview-check">✓</div>
                  <h4>Light Theme</h4>
                  <span class="theme-badge">Cream & Gold</span>
                </div>
                <div class="theme-preview-sample">
                  <div class="sample-modal">
                    <div class="sample-modal-header light">Game Modal</div>
                    <div class="sample-modal-body light">
                      <div class="sample-stat-card light">
                        <span class="sample-icon">❤️</span>
                        <span class="sample-value">10</span>
                      </div>
                      <div class="sample-button light">Roll Dice</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="theme-preview-card" data-theme="neon">
                <div class="theme-preview-header">
                  <div class="theme-preview-check">✓</div>
                  <h4>Tokyo Neon</h4>
                  <span class="theme-badge">Coming Soon</span>
                </div>
                <div class="theme-preview-sample">
                  <div class="sample-modal">
                    <div class="sample-modal-header neon">Game Modal</div>
                    <div class="sample-modal-body neon">
                      <div class="sample-stat-card neon">
                        <span class="sample-icon">❤️</span>
                        <span class="sample-value">10</span>
                      </div>
                      <div class="sample-button neon">Roll Dice</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- Kaiju Classic Theme -->
              <div class="theme-preview-card" data-theme="classic">
                <div class="theme-preview-header">
                  <div class="theme-preview-check">✓</div>
                  <h4>Kaiju Classic</h4>
                  <span class="theme-badge">Coming Soon</span>
                ...
                <div class="theme-preview-sample">
                  <div class="sample-modal">
                    <div class="sample-modal-header classic">Game Modal</div>
                    <div class="sample-modal-body classic">
                      <div class="sample-stat-card classic">
                        <span class="sample-icon">❤️</span>
                        <span class="sample-value">10</span>
                      </div>
                      <div class="sample-button classic">Roll Dice</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="field">
            <label class="field-label">🃏 Power Card Theme</label>
            <div class="radio-group">
              <label class="radio-option">
                <input type="radio" name="powerCardTheme" value="standard" checked>
                <span>Standard - Classic card styling with gradient backgrounds</span>
              </label>
              <label class="radio-option">
                <input type="radio" name="powerCardTheme" value="minimal">
                <span>Minimal - Clean, flat design with subtle colors</span>
              </label>
              <label class="radio-option">
                <input type="radio" name="powerCardTheme" value="vibrant">
                <span>Vibrant - Bold colors with enhanced visual effects</span>
              </label>
            </div>
            <div class="field-help">Choose the visual style for power cards</div>
          </div>
        </div>
      </div>
          </div>
      ...
      <div class="tab-content" data-tab-content="advanced" style="display: none;">
        <div class="section">
          ...
          <div class="field">
            <div class="save-info-advanced" style="font-size: 1.2vh; color: #3fc1c9; margin-bottom: 1.2vh; padding: 0.8vh 1.2vw; background: rgba(63, 193, 201, 0.1); display: none;">
          ...
          <div class="field">
            ...
            <div style="display: flex; gap: 8px; margin-top: 8px; flex-wrap: wrap;">
              <button type="button" class="btn btn-sm" data-persistence-action="save-now">
                💾 Save Now
              </button>
              <button type="button" class="btn btn-sm" data-persistence-action="export-save">
                📥 Export Save File
              </button>
              <button type="button" class="btn btn-sm" data-persistence-action="import-save">
                📤 Import Save File
              </button>
              <button type="button" class="btn btn-sm" data-persistence-action="clear-save" style="background: #e67e22; border-color: #d35400;">
                🗑️ Clear Saved Game
              </button>
        ...
        <div class="section">
          ...
          <div class="field">
            ...
            <div style="display: flex; gap: 8px; margin-top: 8px;">
              <button type="button" class="btn btn-sm export-settings-btn">
                📤 Export Settings
              </button>
              <button type="button" class="btn btn-sm import-settings-btn">
                📥 Import Settings
              </button>
          ...
          <div class="field">
            ...
            <div style="display: flex; gap: 8px; margin-top: 8px;">
              <button type="button" class="btn btn-sm reset-settings-btn" style="background: #f39c12; border-color: #e67e22;">
                🔄 Reset to Defaults
              </button>
              <button type="button" class="btn btn-sm clear-all-data-btn" style="background: #e74c3c; border-color: #c0392b;">
                🗑️ Clear All Data
              </button>
            </div>
          ...
          <div class="field">
            ...
            <div style="display:flex;gap:8px;margin-top:8px;margin-bottom:12px;">
              <input type="text" id="settings-archive-search" placeholder="Search archives..." 
                     style="flex:1;padding:8px;border:1px solid #ddd;font-size:12px;">
              <select id="settings-archive-filter" style="padding:8px;border:1px solid #ddd;font-size:12px;">
                <option value="all">All Types</option>
                <option value="game">Game Logs</option>
                <option value="aidt">AI Decisions</option>
                <option value="auto">Auto Archives</option>
              </select>
              <button type="button" id="settings-archive-refresh" class="btn btn-sm" style="display:inline-flex;align-items:center;justify-content:center;gap:4px;">
      ...
      <div class="tab-content" data-tab-content="ai" style="display:none;">
        <div class="section">
          ...
          <div class="field">
            ...
            <div id="settings-analytics-overview" class="analytics-overview-panel">
              <div class="analytics-grid">
                <div class="analytics-stat-card">
                  <div class="analytics-stat-value" id="analytics-total-games">0</div>
                  <div class="analytics-stat-label">Total Games</div>
                </div>
                <div class="analytics-stat-card">
                  <div class="analytics-stat-value" id="analytics-avg-duration">0min</div>
                  <div class="analytics-stat-label">Avg Duration</div>
                </div>
                <div class="analytics-stat-card">
                  <div class="analytics-stat-value" id="analytics-ai-decisions">0</div>
                  <div class="analytics-stat-label">AI Decisions</div>
                </div>
                <div class="analytics-stat-card">
                  <div class="analytics-stat-value" id="analytics-unique-players">0</div>
                  <div class="analytics-stat-label">Players</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div id="settings-analytics-performance" class="analytics-performance-panel">
          ...
          <div class="field" style="margin-top:16px;">
            <div style="display:flex;gap:12px;flex-wrap:wrap;">
              <button type="button" id="settings-refresh-analytics" class="btn btn-sm">
                🔄 Refresh Analytics
              </button>
              <button type="button" id="settings-export-analytics" class="btn btn-sm">
                📤 Export Data
              </button>
            </div>
          </div>
        ...
        <div class="section">
          ...
          <div class="field">
            ...
            <div style="display:flex;gap:12px;flex-wrap:wrap;margin-top:8px;">
              <button type="button" id="settings-ai-modal" class="btn btn-sm">
                🧠 Open Full Tree Modal
              </button>
              <button type="button" id="settings-ai-export" class="btn btn-sm">
                📤 Export AI Data
              </button>
              <button type="button" id="settings-ai-clear" class="btn btn-sm">
                🗑 Clear Tree
              </button>
            </div>
          </div>
        ...
        <div class="section" style="margin-top:20px;">
          ...
          <div class="field" style="margin-top:6px;">
            ...
            <div id="dev-win-odds-panel" class="win-odds-panel" style="background:#1a1a1a;border:2px solid #333;overflow:hidden;display:flex;flex-direction:column;position:relative;">
              ...
              <div class="win-odds-body" id="dev-win-odds-chart" style="padding:16px;display:flex;flex-direction:column;gap:12px;min-height:180px;max-height:240px;overflow-y:auto;background:#0d0d0d;">
                <div style="font-size:11px;opacity:.5;text-align:center;padding:20px;color:#888;">Waiting for data...</div>
              </div>
              <div id="dev-win-odds-insights" class="win-odds-insights" style="padding:0 16px 16px 16px;background:#0d0d0d;overflow-y:auto;max-height:200px;"></div>
              <div class="win-odds-footer" style="display:flex;align-items:center;gap:8px;padding:10px 16px;border-top:2px solid #333;background:#111;">
                <label style="font-size:11px;display:flex;align-items:center;gap:6px;margin:0;white-space:nowrap;font-weight:500;color:#999;">
                  <input type="checkbox" id="dev-win-odds-auto" checked style="width:14px;height:14px;cursor:pointer;" /> Auto
                </label>
                <div id="dev-win-odds-trend" style="flex:1;font-size:10px;opacity:.6;line-height:1.3;text-align:center;color:#888;">–</div>
                <button type="button" id="dev-win-odds-clear" class="win-odds-clear-btn" title="Clear history" style="background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);color:#ff6b6b;padding:4px 10px;font-size:11px;line-height:1;cursor:pointer;transition:all 0.2s ease;font-weight:500;">🗑 Clear</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="tab-content" data-tab-content="devtools" style="display:none;">
        <div class="section" style="max-height:60vh;overflow:auto;">
          ...
          <div class="field">
            ...
            <div id="dev-debug-console" style="margin-top:0.8vh;max-height:22vh;overflow:auto;font-family:monospace;font-size:11px;line-height:1.4;border:1px solid #333;border-radius:0.6vh;padding:0.8vh;background:#0d1117;">
              <div style="opacity:.5;color:#888;">Debug output will appear here...</div>
            </div>
    ...
    try {
      ...
      const tableRows = list.slice(0,100).map((a, idx) => {
        ...
        return `
          <tr style='border-bottom:1px solid #333;'>
            <td style='padding:0.8vh 0.5vw;text-align:center;'>
              <input type='checkbox' class='archive-checkbox' data-archive-id='${a.id}' style='cursor:pointer;'>
            </td>
            <td style='padding:0.8vh 0.5vw;text-align:center;font-weight:600;color:#888;font-size:1.1vh;'>${idx + 1}</td>
            <td style='padding:0.8vh 0.8vw;color:#ddd;font-size:1.1vh;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;' title='${fileName}'>${fileName}</td>
            <td style='padding:0.8vh 0.5vw;text-align:center;color:#f4d03f;font-size:1.1vh;font-weight:600;'>${archiveType}</td>
            <td style='padding:0.8vh 0.8vw;color:#999;font-size:1.1vh;'>${formattedDate}</td>
            <td style='padding:0.8vh 0.5vw;text-align:center;'>
              <button type='button' class='btn btn-sm' data-archive-replay='${a.id}' style='background:#555;border:1px solid #666;color:#ddd;padding:4px 8px;font-size:10px;'>
                👁
              </button>
            </td>
            <td style='padding:0.8vh 0.5vw;text-align:center;'>
              <button type='button' class='btn btn-sm' data-archive-delete='${a.id}' style='background:#e74c3c;border-color:#c0392b;padding:4px 8px;font-size:10px;'>
                🗑
              </button>
            </td>
          </tr>
      ...
      host.innerHTML = `
        <div style='display:flex;flex-direction:column;width:100%;'>
          <table class='archive-table' style='width:100%;border-collapse:collapse;background:#1a1a1a;font-family:inherit;'>
            <thead>
              <tr style='background:#000;color:#f4d03f;'>
                <th style='padding:1vh 0.5vw;text-align:center;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;width:30px;'>
                  <input type='checkbox' id='archive-select-all' style='cursor:pointer;'>
                </th>
                <th style='padding:1vh 0.5vw;text-align:center;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;width:35px;'>#</th>
                <th style='padding:1vh 0.8vw;text-align:left;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;min-width:120px;max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;'>File Name</th>
                <th style='padding:1vh 0.5vw;text-align:center;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;width:50px;'>Type</th>
                <th style='padding:1vh 0.8vw;text-align:left;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;width:90px;'>Date</th>
                <th style='padding:1vh 0.5vw;text-align:center;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;width:60px;'>View</th>
                <th style='padding:1vh 0.5vw;text-align:center;font-weight:600;font-size:1.2vh;border-bottom:1px solid #333;width:60px;'>Delete</th>
              </tr>
            </thead>
            <tbody>
              ${tableRows}
          ...
          <div class='archive-actions' style='display:flex;justify-content:flex-end;padding:1.5vh 1vw;background:#0a0a0a;border-top:1px solid #333;'>
            <button type='button' id='bulk-delete-archives' class='btn btn-sm' disabled style='padding:0.8vh 1.5vw;font-size:1.2vh;background:#e74c3c;border-color:#c0392b;'>
      ...
      host.addEventListener('click', async (e) => {
        ...
        if (viewBtn) {
          ...
          const modalElement = newModalSystem.createModal('gameLog', '📜 Game Log - Archive', modalContent, { width: '1000px', resizable: true });
...
export function openWinOddsQuickModal(){
  ...
  function renderPowerCardAnalysis(player, odds, state, fontSize2, gap1, gap2, pad1, avgScale) {
    ...
    let html = `<div class='wo-power-card-analysis' style='font-size:${fontSize2}px;padding:${pad1}px;background:rgba(0,0,0,0.3);border-top:1px solid #2c3440;max-height:${Math.round(300*avgScale)}px;overflow-y:auto;'>
      <div class='wo-analysis-header' style='margin-bottom:${gap2}px;padding-bottom:${gap1}px;border-bottom:1px solid #2c3440;'>
        <div class='wo-analysis-title' style='font-weight:600;color:#b8860b;margin-bottom:${gap1}px;'>🃏 ${playerName}'s Power Card Analysis</div>
        <div class='wo-analysis-subtitle' style='opacity:0.7;font-size:0.95em;'>Win Odds: ${playerOdds.toFixed(1)}% • Energy: ⚡${playerEnergy}</div>
      </div>`;
    ...
    html += `<div style='min-height:80px;'>
      <div class='wo-owned-title' style='font-weight:600;margin-bottom:${gap1}px;opacity:0.8;'>✅ Your Cards (${playerCards.length})</div>`;
    
    if (ownedAnalysis.length > 0) {
      ownedAnalysis.forEach(card => {
        html += `<div class='wo-card-item wo-card-owned' data-card-id='${card.id}' style='background:rgba(139,105,20,0.12);border:1px solid rgba(184,134,11,0.35);border-radius:${gap1}px;padding:${gap1}px ${gap2}px;margin-bottom:${gap1}px;cursor:pointer;transition:all 0.2s;' onmouseover="this.style.background='rgba(139,105,20,0.2)';this.style.borderColor='rgba(184,134,11,0.5)'" onmouseout="this.style.background='rgba(139,105,20,0.12)';this.style.borderColor='rgba(184,134,11,0.35)'">
          <div style='display:flex;justify-content:space-between;align-items:center;'>
            <strong class='wo-card-name' style='font-size:0.95em;'>${card.name}</strong>
            <span class='wo-card-contribution' style='color:#b8860b;font-weight:600;font-size:0.9em;'>+${card.contribution}%</span>
          </div>
          <div class='wo-card-reason' style='opacity:0.7;font-size:0.85em;margin-top:${gap1}px;'>${card.reason}</div>
        </div>`;
      });
    } else {
    ...
    html += `<div style='min-height:80px;'>
      <div class='wo-available-title' style='font-weight:600;margin-bottom:${gap1}px;opacity:0.8;'>💰 Available to Buy</div>`;
    
    if (availableAnalysis.length > 0) {
      availableAnalysis.forEach(card => {
        const canAfford = card.affordable;
        const bgColor = canAfford ? 'rgba(184,134,11,0.08)' : 'rgba(100,100,100,0.08)';
        const borderColor = canAfford ? 'rgba(184,134,11,0.3)' : 'rgba(100,100,100,0.25)';
        const hoverBg = canAfford ? 'rgba(184,134,11,0.15)' : 'rgba(100,100,100,0.12)';
        const hoverBorder = canAfford ? 'rgba(184,134,11,0.45)' : 'rgba(100,100,100,0.3)';
        const icon = canAfford ? '💎' : '🔒';
        
        html += `<div class='wo-card-item wo-card-available' data-card-id='${card.id}' style='background:${bgColor};border:1px solid ${borderColor};border-radius:${gap1}px;padding:${gap1}px ${gap2}px;margin-bottom:${gap1}px;${!canAfford ? 'opacity:0.6;' : ''}cursor:pointer;transition:all 0.2s;' onmouseover="this.style.background='${hoverBg}';this.style.borderColor='${hoverBorder}'" onmouseout="this.style.background='${bgColor}';this.style.borderColor='${borderColor}'">
          <div style='display:flex;justify-content:space-between;align-items:center;'>
            <strong class='wo-card-name' style='font-size:0.95em;'>${icon} ${card.name}</strong>
            <span class='wo-card-odds' style='color:#8b6914;font-weight:600;font-size:0.9em;'>+${card.oddsIncrease.toFixed(1)}%</span>
          </div>
          <div style='display:flex;justify-content:space-between;align-items:center;margin-top:${gap1}px;'>
            <span class='wo-card-reason' style='opacity:0.7;font-size:0.85em;'>${card.reason}</span>
            <span class='wo-card-cost' style='font-size:0.85em;font-weight:600;'>⚡${card.cost}</span>
          </div>
        </div>`;
      });
    } else {
    ...
    if (availableAnalysis.length > 0) {
      ...
      if (topCard.affordable) {
        html += `<div class='wo-best-buy-tip' style='margin-top:${gap2}px;padding:${gap1}px ${gap2}px;background:rgba(184,134,11,0.1);border:1px solid rgba(184,134,11,0.35);border-radius:${gap1}px;font-size:0.85em;'>
    ...
    if (winOdds.mode === 'bars') {
      ...
      html = `<div style="padding:${pad1}px;font-size:${fontSize1}px;"><table style='width:100%;border-collapse:collapse;'>
        <thead><tr style='text-align:left;'>
          <th class='wo-table-header' style='padding:${gap1}px ${gap2}px;border-bottom:1px solid #222;background:linear-gradient(135deg,#b8860b,#8b6914);color:#fff;'>Player</th>
          <th class='wo-table-header' style='padding:${gap1}px ${gap2}px;border-bottom:1px solid #222;background:linear-gradient(135deg,#b8860b,#8b6914);color:#fff;'>Odds %</th>
          <th class='wo-table-header' style='padding:${gap1}px ${gap2}px;border-bottom:1px solid #222;background:linear-gradient(135deg,#b8860b,#8b6914);color:#fff;'>Δ</th>
          <th class='wo-table-header' style='padding:${gap1}px ${gap2}px;border-bottom:1px solid #222;background:linear-gradient(135deg,#b8860b,#8b6914);color:#fff;'>Trend</th>
        </tr></thead><tbody>`;
      players.forEach((p,idx) => {
        const { pct, arrow, deltaStr, tooltip, spark } = rowCommon(p);
        const c = monsterColor(p, idx);
...
export function createGameLogModal(archiveId = null) {
  ...
  content.innerHTML = `
    <div class="unified-modal-form">
      ...
      <div class="modal-content-scrollable" id="game-log-content">
        <div class="log-loading" style="text-align: center; font-style: italic;">
          📜 Loading game log...
        </div>
      </div>
    </div>
  ...
  const __gameLogModal = newModalSystem.createModal('gameLog', '📜 Game Log', content, { width: '1000px', resizable: true });
...
export function createAIDecisionModal() {
  ...
  return newModalSystem.createModal('aiDecision', '✨ AI Decision Tree', content, { width: '1200px', resizable: true });
}
