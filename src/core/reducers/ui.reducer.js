...
export function uiReducer(state = initial, action) {
  switch (action.type) {
    ...
    case UI_PLAYER_POWER_CARDS_OPEN: {
      const { playerId } = action.payload;
      return { ...state, playerPowerCards: { playerId } };
    }
    case UI_PLAYER_POWER_CARDS_CLOSE: {
      return { ...state, playerPowerCards: { playerId: null } };
    }
