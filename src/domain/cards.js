...
export function buildBaseCatalog() {
  ...
  return [
    ...
    { id: 'high-altitude-bombing', name: 'High Altitude Bombing', cost: 4, type: 'discard', effect: { kind: 'damage_all_including_self', value: 3 }, description: 'All monsters (including you) take 3 damage.', emoji: '✈️' },
    ...
    { id: 'jet-fighters', name: 'Jet Fighters', cost: 5, type: 'discard', effect: { kind: 'vp_and_take_damage', value: 5, damage: 4 }, description: '+5★ and take 4 damage', emoji: '�️' },
    ...
    { id: 'national-guard', name: 'National Guard', cost: 3, type: 'discard', effect: { kind: 'vp_and_take_damage', value: 2, damage: 2 }, description: '+2★ and take 2 damage.', emoji: '�️' },
