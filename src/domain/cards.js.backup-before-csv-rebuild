...
export function buildBaseCatalog() {
  ...
  return [
    ...
    { id: 'alien-metabolism', name: 'Alien Metabolism', cost: 3, type: 'keep', effect: { kind: 'cheaper_cards', value: 1 }, description: 'Buying cards costs 1 less energy (minimum 0).', emoji: '🍊' },
    ...
    { id: 'dedicated-news-team', name: 'Dedicated News Team', cost: 3, type: 'keep', effect: { kind: 'tokyo_bonus_vp', value: 1 }, description: 'Gain 1 extra Victory Point each time you score points.', emoji: '🏆' },
    ...
    { id: 'even-bigger', name: 'Even Bigger', cost: 4, type: 'keep', effect: { kind: 'health_bonus', value: 2 }, description: 'Your maximum Health is increased by 2 (to 12).', emoji: growthSVG, lightEmoji: true },
    ...
    { id: 'fire-breathing', name: 'Fire Breathing', cost: 3, type: 'keep', effect: { kind: 'attack_bonus', value: 1 }, description: 'Deal 1 extra damage each turn you attack.', emoji: '🔥' },
    { id: 'friend-of-children', name: 'Friend of Children', cost: 4, type: 'keep', effect: { kind: 'heart_vp', value: 1 }, description: 'Gain 1★ at the start of your turn if you rolled at least 1 Heart.', emoji: familySVG, lightEmoji: true },
    ...
    { id: 'giant-brain', name: 'Giant Brain', cost: 5, type: 'keep', effect: { kind: 'reroll_bonus', value: 1 }, description: 'You have 1 extra re-roll each turn.', emoji: '🧠' },
    ...
    { id: 'it-has-a-child', name: 'It Has A Child', cost: 2, type: 'discard', effect: { kind: 'draw_cards', value: 1 }, description: 'Draw 3 extra Power cards (keep 2, discard 1).', emoji: '🍼', lightEmoji: true },
    { id: 'jets', name: 'Jets', cost: 5, type: 'keep', effect: { kind: 'leave_tokyo_attack', value: 1 }, description: 'You may leave Tokyo after attacking (before counter-attack).', emoji: rocketSVG, lightEmoji: true },
    { id: 'made-in-a-lab', name: 'Made in a Lab', cost: 2, type: 'keep', effect: { kind: 'science_bonus', value: 1 }, description: 'Gain 2★ for each set of 1-2-3 you roll.', emoji: '🔬' },
    { id: 'metamorphosis', name: 'Metamorphosis', cost: 6, type: 'discard', effect: { kind: 'full_heal', value: 1 }, description: 'Heal to your maximum Health.', emoji: '💖' },
    ...
    { id: 'plot-twist', name: 'Plot Twist', cost: 3, type: 'discard', effect: { kind: 'change_dice', value: 1 }, description: 'Change one die to any face you want.', emoji: refreshSVG, lightEmoji: true },
    { id: 'psychic-probe', name: 'Psychic Probe', cost: 2, type: 'keep', effect: { kind: 'force_reroll', value: 1 }, description: 'Force another monster to reroll 2 of their dice.', emoji: '🌀' },
    { id: 'rapid-healing', name: 'Rapid Healing', cost: 3, type: 'keep', effect: { kind: 'heal_energy', value: 1 }, description: 'Gain 1 Health when you buy a Power card.', emoji: '💚' },
    { id: 'regeneration', name: 'Regeneration', cost: 4, type: 'keep', effect: { kind: 'heal_turn_start', value: 1 }, description: 'Heal 1 Health at the start of your turn if not at maximum.', emoji: '❤️' },
    { id: 'rooting-for-the-underdog', name: 'Rooting for the Underdog', cost: 3, type: 'keep', effect: { kind: 'low_health_bonus', value: 1 }, description: 'Gain 1 Energy at the start of your turn if your Health is 5 or less.', emoji: '🎉' },
    ...
    { id: 'stretchy', name: 'Stretchy', cost: 3, type: 'keep', effect: { kind: 'reach_bay', value: 1 }, description: 'You can attack Tokyo Bay from outside Tokyo (when 5+ players).', emoji: '🦾' },
    ...
    // Missing official base game cards
    { id: 'apartment-building', name: 'Apartment Building', cost: 5, type: 'discard', effect: { kind: 'destroy_for_vp', value: 3 }, description: 'Destroy it immediately to gain 3 Victory Points.', emoji: '🏢' },
    { id: 'high-altitude-bombing', name: 'High Altitude Bombing', cost: 4, type: 'discard', effect: { kind: 'damage_all_lose_vp', value: 3, cost: 2 }, description: 'Deal 3 damage to all other monsters. Lose 2 Victory Points.', emoji: '✈️' },
    { id: 'mimic', name: 'Mimic', cost: 2, type: 'keep', effect: { kind: 'copy_card', value: 1 }, description: 'Choose 1 Keep card owned by another monster. Mimic has the same power.', emoji: '🎭' },
    { id: 'poison-quills', name: 'Poison Quills', cost: 4, type: 'keep', effect: { kind: 'reflect_damage', value: 2 }, description: 'When you take damage, deal 2 damage back to the attacker.', emoji: '🦔' },
    { id: 'poison-spit', name: 'Poison Spit', cost: 6, type: 'discard', effect: { kind: 'damage_select', value: 3, maxTargets: 1 }, description: 'Deal 3 damage to 1 monster of your choice.', emoji: '☠️', lightEmoji: true }
